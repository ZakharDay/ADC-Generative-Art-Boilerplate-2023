...
class PrototypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prototype" do
    assert_difference("Prototype.count") do
      post prototypes_url, params: { prototype: { about: @prototype.about, name: @prototype.name } }
    end
  ...
  test "should update prototype" do
    patch prototype_url(@prototype), params: { prototype: { about: @prototype.about, name: @prototype.name } }
